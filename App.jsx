...
function CalcPage({ services = [], reloadServices }) {
      ...
      <div style={s.content}>
        ...
        {showNew && (
          <div style={{ ...s.card, marginBottom: 16, border: `1px solid ${C.purple}55` }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              <Field label="Data do Pedido">
                <input type="date" style={s.input} value={newForm.order_date} onChange={(e) => setNewForm((f) => ({ ...f, order_date: e.target.value }))} />
              </Field>
              <Field label="Prazo">
                <input type="date" style={s.input} value={newForm.delivery_date} onChange={(e) => setNewForm((f) => ({ ...f, delivery_date: e.target.value }))} />
              </Field>
            </div>
...
export default function App() {
  ...
  function renderPage() {
    switch (page) {
      ...
      case "calc":
        return <CalcPage services={services} reloadServices={reloadServices} />;
      case "orders":
