...
function Logo({ size = 32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
      <ellipse cx="32" cy="48" rx="18" ry="10" fill="#3D2066" />
      <path d="M14 32 Q14 22 32 22 Q50 22 50 32 L46 48 Q40 56 32 56 Q24 56 18 48 Z" fill="#7B4FA6" />
      <path d="M22 16 L26 32 M42 16 L38 32" stroke="#9B6DC5" strokeWidth="2" />
      <rect x="24" y="4" width="16" height="14" rx="3" fill="#5a3080" stroke="#9B6DC5" strokeWidth="1.5" />
      <path d="M30 18 L30 28 M34 18 L34 28" stroke="#C9A8FF" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="32" cy="38" r="7" fill="#C9A8FF" opacity="0.15" />
      <text x="29" y="42" fontSize="10" fill="#EEE8FF">🐱</text>
      <path d="M50 30 L56 28 M50 36 L58 36 M50 42 L55 44" stroke="#C9A8FF" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1
            style={{
              ...
              fontSize: 28,
              fontWeight: 800,
              background: `linear-gradient(90deg, ${C.lilac}, ${C.textSoft})`,
    ...
    <>
      <div style={{ ...s.content }}>
        <div style={{ textAlign: "center", padding: "16px 0 8px" }}>
          <Logo size={40} />
          <h2 style={{ margin: "8px 0 2px", fontSize: 22, fontWeight: 800 }}>LayerLab</h2>
          <p style={{ color: C.textSoft, fontSize: 14, margin: 0 }}>Painel de Controle — Ola! 👋</p>
        </div>
        ...
        >
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div>
              <p style={{ color: C.textSoft, fontSize: 11, margin: "0 0 4px", textTransform: "uppercase", fontWeight: 600 }}>
                Receita Total
              </p>
              <p style={{ color: "#69F0AE", fontSize: 18, fontWeight: 700, margin: 0 }}>
                {fmtBRL(received)}
              </p>
            </div>
            <div>
          ...
          {profit < 0 && (
            <p style={{ color: "#FF8A80", fontSize: 12, margin: "8px 0 0", textAlign: "center" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 16 }}>
          {[
            { label: "Aguardando", status: "Pedido Recebido", icon: "📥", color: C.purple },
            { label: "Producao", status: "Em Producao", icon: "⚙️", color: "#1565C0" },
            { label: "Acabamento", status: "Acabamento", icon: "✨", color: "#6A1B9A" },
            { label: "Prontos", status: "Finalizado", icon: "✅", color: "#2E7D32" },
          ].map((item) => (
            <div
              key={item.status}
              style={{
            ...
            >
              ...
              <div>
                <p style={{ margin: 0, fontSize: 11, color: C.textSoft }}>{item.label}</p>
                <p style={{ margin: 0, fontSize: 20, fontWeight: 700, color: item.color }}>
        ...
        {recent.map((o) => (
          <div key={o.id} style={{ ...s.card, padding: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                <p style={{ margin: "0 0 2px", fontWeight: 600, fontSize: 14 }}>{o.client_name || "—"}</p>
                <p style={{ margin: 0, fontSize: 12, color: C.textSoft }}>{o.product_name || o.description || "—"}</p>
              </div>
              <span style={s.tag(STATUS_COLOR[o.status] || C.purple)}>
      ...
      {result && (
        <div style={{ ...s.card, marginTop: 8 }}>
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: 26, fontWeight: 800 }}>{fmtBRL(result.price)}</p>
          </div>
        </div>
      )}
    </div>
  ...
  return (
    ...
    >
      ...
      <div style={s.header}>
        ...
        <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, flex: 1 }}>Ordem de Servico</h2>
...
function OrdersPage({ clients, catalog, services: svcList }) {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, flex: 1 }}>📋 Pedidos</h2>
...
function ClientsPage() {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, flex: 1 }}>👤 Clientes</h2>
      ...
      <div style={s.content}>
        ...
        {display.map((c) => (
          <div key={c.id} style={{ ...s.card, padding: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div style={{ flex: 1 }} onClick={() => openEdit(c)} style={{ flex: 1, cursor: "pointer" }}>
...
function CatalogPage() {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, flex: 1 }}>🗂️ Catalogo</h2>
...
function SuppliesPage() {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, flex: 1 }}>📦 Insumos</h2>
      ...
      <div style={s.content}>
        ...
        <div style={{ ...s.card, background: "rgba(198,40,40,0.12)", border: "1px solid #C6282855", marginBottom: 16 }}>
          ...
          <p style={{ margin: "4px 0 0", fontSize: 24, fontWeight: 800, color: "#FF8A80" }}>{fmtBRL(total)}</p>
        </div>
...
function ServicesPage() {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, flex: 1 }}>🎨 Servicos</h2>
...
${supplies.map((s) => `<tr><td>${s.name}</td><td>${s.category || "—"}</td><td>${fmtBRL((s.price || 0) * (s.quantity || 1))}</td></tr>`).join("")}
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, flex: 1 }}>📊 Financeiro</h2>
      ...
      <div style={s.content}>
        ...
        >
          ...
          <p style={{ margin: "0 0 4px", fontSize: 28, fontWeight: 800, color: profit >= 0 ? "#69F0AE" : "#FF8A80" }}>
            {fmtBRL(profit)}
          </p>
          {profit < 0 && (
