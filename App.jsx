      ...
      <div style={{ ...s.content, paddingTop: 12 }}>
        ...
        {true && (
          <div>
            ...
            {/* Produtos do catalogo (itens prontos) */}
            <div style={{ marginTop: 8, borderTop: `1px solid ${C.cardBorder}`, paddingTop: 14 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                <p style={{ margin: 0, fontWeight: 700, fontSize: 14 }}>Produtos do catalogo</p>
                {totalProducts > 0 && <p style={{ margin: 0, color: "#69F0AE", fontWeight: 700, fontSize: 14 }}>{fmtBRL(totalProducts)}</p>}
              </div>
              <p style={{ margin: "0 0 10px", fontSize: 12, color: C.textSoft }}>
                Adicione itens ja prontos. O valor soma ao pedido.
              </p>
              <CatalogPicker
                items={catalog}
