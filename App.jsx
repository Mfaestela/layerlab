...
function HomePage({ setPage, orders, supplies }) {
  ...
  const tiles = [
    { id: "calc", icon: "🧮", label: "Calcular", tint: "#9B6DC5" },
    { id: "orders", icon: "📋", label: "Pedidos", tint: "#5B8DEF" },
    { id: "clients", icon: "👤", label: "Clientes", tint: "#4FC3F7" },
    { id: "catalog", icon: "🗂️", label: "Catalogo", tint: "#FFB74D" },
    { id: "supplies", icon: "📦", label: "Insumos", tint: "#FF8A80" },
    { id: "services", icon: "🎨", label: "Servicos", tint: "#C77DFF" },
    { id: "finance", icon: "📊", label: "Financas", tint: "#69F0AE" },
  ];
