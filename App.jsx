      ...
      <div style={{ ...s.content, paddingTop: 12, paddingBottom: 160 }}>
        ...
        {true && (
          <div>
            ...
            {/* Valor do produto personalizado (valor final) */}
            <div
              style={{
            ...
            >
              <MoneyField
                label="Valor do produto personalizado"
              ...
              <p style={{ margin: "2px 2px 10px", fontSize: 11, color: C.textSoft }}>
                Valor da peca impressa. Itens do catalogo somam a este valor.
              </p>
              <button
            ...
            {/* Adicionar item do catalogo (botao que abre busca) */}
            <div style={{ marginBottom: 12 }}>
              <button
              ...
              {showCatalogPicker && (
                <div style={{ marginTop: 10 }}>
                  <p style={{ margin: "0 0 10px", fontSize: 12, color: C.textSoft }}>
                    Itens ja prontos. O valor soma ao pedido.
                  </p>
                  <CatalogPicker
                    items={catalog}
              ...
              {/* Itens ja adicionados (resumo, mesmo com busca fechada) */}
              {!showCatalogPicker && selProducts.length > 0 && (
                <div style={{ marginTop: 8 }}>
                  {selProducts.map((p) => (
                    <div key={p.id} style={{ display: "flex", justifyContent: "space-between", fontSize: 13, color: C.textSoft, padding: "3px 2px" }}>
