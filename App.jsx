                  ...
                  <div>
                    ...
                    <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                      ...
                      <button onClick={() => updateOrderStatus(o.id + "_paid", !o.paid, o)} style={{
                        padding: "3px 10px", borderRadius: 20, fontSize: 12, fontWeight: 700, cursor: "pointer", border: "none",
                        background: o.paid ? "#D4EDDA" : "#FFF3CD", color: o.paid ? "#2E7D32" : "#B07800"
                      }}>
                        {o.paid ? "💰 Pago" : "⏳ Aguardando pagamento"}
                      </button>
                    </div>
                  </div>
