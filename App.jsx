  ...
  if (view === "edit" && editingOrder) {
    return (
      <div style={{ display: "flex", flexDirection: "column", minHeight: "calc(100vh - 140px)" }}>
        ...
        <div style={{ position: "fixed", bottom: 60, left: 0, right: 0, background: C.white, borderTop: `1.5px solid ${C.lavenderMid}`, padding: "8px 16px", display: "flex", gap: 8, justifyContent: "center", zIndex: 100, maxWidth: 600, margin: "0 auto" }}>
          <button onClick={() => {
          ...
          }} style={{ flex: 1, padding: "8px 10px", borderRadius: 10, border: `1.5px solid ${C.primary}`, background: C.lavender, color: C.primary, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>
            🧾 Faturar
          </button>
          <button onClick={async () => { await saveEdit(); }} disabled={saving} style={{ flex: 1, padding: "8px 10px", borderRadius: 10, border: "none", background: `linear-gradient(135deg, ${C.primaryDark}, ${C.primary})`, color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>
            {saving ? "..." : "💾 Salvar"}
          </button>
          <button onClick={() => setView("list")} style={{ flex: 1, padding: "8px 10px", borderRadius: 10, border: `1.5px solid ${C.lavenderMid}`, background: C.white, color: C.textMid, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>
            ✕ Sair
          </button>
        </div>
      </div>
