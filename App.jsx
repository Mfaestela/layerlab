                  ...
                  <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                    <select value={o.status} onChange={e => {
                      if (e.target.value === "Entregue" && !o.paid) {
                        alert("⚠️ Marque o pagamento como recebido antes de entregar!");
                        return;
                      }
                    ...
                    <button onClick={() => updateOrderStatus(o.id + "_paid", !o.paid, o)} style={{
                      ...
                      border: `1.5px solid ${o.paid ? "#C8E6C9" : "#FFE082"}`,
                      background: o.paid ? "#D4EDDA" : "#FFF9E6",
                      color: o.paid ? "#2E7D32" : "#B07800",
                      minWidth: 36
                    }} title={o.paid ? "Pago" : "Aguardando pagamento"}>
                      {o.paid ? "💲✓" : "💲?"}
                    </button>
